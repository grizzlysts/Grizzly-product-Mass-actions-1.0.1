...
class Grizzly_Productaction_Model_System_Config_Source_View
{
    public function toOptionArray()
    {
        return array(
			...
			array('value' => 'modwholesaleprice', 'label'=>Mage::helper('adminhtml')->__('Modify Wholesale Price')),
			array('value' => 'modretailerprice', 'label'=>Mage::helper('adminhtml')->__('Modify Retailer Price')),
    ...
    public function toArray()
    {
        return array(
			...
			"modwholesaleprice" => Mage::helper('adminhtml')->__('Modify Wholesale Price'),
			"modretailerprice" => Mage::helper('adminhtml')->__('Modify Retailer Price'),
